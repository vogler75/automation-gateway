...
public abstract class OpcUaVerticle extends AbstractVerticle {
                ...
                client = OpcUaClient.create(
                        ...
                        configBuilder ->
                                configBuilder
                                        ...
                                        .setCertificate(KeyStoreLoader.keyStoreLoader.getClientCertificate())
                                        .setKeyPair(KeyStoreLoader.keyStoreLoader.getClientKeyPair())
    ...
    private Future<Void> connectClientAsync() {
        Promise<Void> ret = Promise.promise();
        if (client==null) {
            ret.fail("ConnectClientAsync where client==null!");
        } else {
